...
2. Mark guards and walls by setting their cell value to `1`. We use the same marker because guard positions also block further expansion, preventing multiple-counting.
